...
// These render as billboard 2D icons inside WebGL node spheres or pill badges

const svgToDataUri = (svg: string) => `data:image/svg+xml;utf8,${encodeURIComponent(svg)}`;

export const flagSvg = svgToDataUri(`
<svg fill="#0d9488" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
...
<svg fill="#3b82f6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
  <path d="M 25 3 L 3 13 L 3 17 L 47 17 L 47 13 Z M 7 20 L 7 38 L 12 38 L 12 20 Z M 16 20 L 16 38 L 21 38 L 21 20 Z M 25 20 L 25 38 L 30 38 L 30 20 Z M 34 20 L 34 38 L 39 38 L 39 20 Z M 43 20 L 43 38 L 48 38 L 48 20 Z M 2 41 L 2 47 L 48 47 L 48 41 Z" fill="#3b82f6"/>
</svg>
`);
...
<svg fill="#8b5cf6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
  <path d="M 25 2 L 6 12 L 6 15 L 44 15 L 44 12 Z M 10 18 L 10 37 L 14 37 L 14 18 Z M 19 18 L 19 37 L 23 37 L 23 18 Z M 28 18 L 28 37 L 32 37 L 32 18 Z M 37 18 L 37 37 L 41 37 L 41 18 Z M 4 40 L 4 46 L 46 46 L 46 40 Z" fill="#8b5cf6"/>
</svg>
`);

export const techSvg = svgToDataUri(`
<svg fill="#10b981" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
  <path d="M 18 3 L 18 7 L 14 7 C 10.134 7 7 10.134 7 14 L 7 18 L 3 18 L 3 22 L 7 22 L 7 28 L 3 28 L 3 32 L 7 32 L 7 36 C 7 39.866 10.134 43 14 43 L 18 43 L 18 47 L 22 47 L 22 43 L 28 43 L 28 47 L 32 47 L 32 43 L 36 43 C 39.866 43 43 39.866 43 36 L 43 32 L 47 32 L 47 28 L 43 28 L 43 22 L 47 22 L 47 18 L 43 18 L 43 14 C 43 10.134 39.866 7 36 7 L 32 7 L 32 3 L 28 3 L 28 7 L 22 7 L 22 3 Z M 14 11 L 36 11 C 37.657 11 39 12.343 39 14 L 39 36 C 39 37.657 37.657 39 36 39 L 14 39 C 12.343 39 11 37.657 11 36 L 11 14 C 11 12.343 12.343 11 14 11 Z M 17 17 L 17 33 L 33 33 L 33 17 Z" fill="#10b981"/>
</svg>
`);

export const policySvg = svgToDataUri(`
<svg fill="#f59e0b" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
  <path d="M 25 3 C 25 3 9 7 9 20 C 9 32 20 44 25 47 C 30 44 41 32 41 20 C 41 7 25 3 25 3 Z M 25 7.4 C 34.4 10.6 37 17.6 37 20 C 37 28.5 29.2 38.3 25 42.4 C 20.8 38.3 13 28.5 13 20 C 13 17.6 15.6 10.6 25 7.4 Z M 23 15 L 23 27 L 27 27 L 27 15 Z M 23 30 L 23 34 L 27 34 L 27 30 Z" fill="#f59e0b"/>
</svg>
`);

export const incidentSvg = svgToDataUri(`
<svg fill="#ef4444" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
  <path d="M 25 2 C 22.3 8.2 16 14.5 16 23 C 16 28 20 32 25 32 C 25 25 29 21 31 18 C 33 22 34 25 34 27 C 34.5 25 35 22.8 35 20.5 C 38.6 24.5 41 30 41 35 C 41 43.3 33.8 49 25 49 C 15.6 49 8 41.8 8 32 C 8 20.2 17.8 11.2 25 2 Z" fill="#ef4444"/>
</svg>
`);

export const dotSvg = (color: string = "#38bdf8") => svgToDataUri(`
...
export function getCategoryDot(category: string): string {
  ...
  return dotSvg(colorMap[category] || "#38bdf8");
}
